{# here we will use the configuration in one big table #}

{% set congigs = [
    {
        "table" : "AIR_BNB.SILVER.SILVER_BOOKINGS",
        "columns" : "SILVER_bookings.*",
        "alias" : "SILVER_bookings"
    },
    { 
        "table" : "AIR_BNB.SILVER.SILVER_LISTINGS",
    ...
    {
        "table" : "AIR_BNB.SILVER.SILVER_HOSTS",
